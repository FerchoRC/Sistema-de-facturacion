    ...
    <section id='testimonios' className='py-20 lg:py-28 bg-white'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
                <h2 className='text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4'>Testimonios de Nuestros Clientes</h2>
                <p className='text-xl text-gray-600 max-w-3xl mx-auto'>Miles de pequeños negocios nos eligen</p>
            </div>
