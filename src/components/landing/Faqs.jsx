...
const FaqItem = ({ faq, isOpen, onClick }) => (
    <div className="border border-gray-200 rounded-xl overflow-hidden">
        ...
        {isOpen && (
            <div className="px-6 pt-3 pb-6 text-gray-600 leading-relaxed border-t border-gray-100">
                {faq.answer}
            </div>
        )}
    </div>
...
const Faqs = () => {
  ...
  return (
    <section id="preguntasFrecuentes" className="py-20 lg:py-28 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4">Preguntas Frecuentes</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Todo lo que necesitas saber sobre el producto y la facturación</p>
        </div>
